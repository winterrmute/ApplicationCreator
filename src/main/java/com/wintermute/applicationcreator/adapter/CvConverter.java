...
/**
 * Converts curriculum vitae data into tex for provided template.
 *
 * @author wintermute
 */
public class CvConverter extends TexConverter
{
    public CvConverter(Map<String, Object> data)
    {
        this.data = data;
    }
    ...
    private Map<String, List<String>> getSkills()
    {
    ...
    private List<String> getSpokenLanguages()
    {
