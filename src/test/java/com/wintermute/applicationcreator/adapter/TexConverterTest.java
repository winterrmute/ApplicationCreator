...
public class TexConverterTest
{
    ...
    public void convertData()
    {
        ...
        String header = underTest.getHeaderData();
        assertThat(header).isEqualTo("\\headerbox{1.2cm}{darkgray}{white}{Azathoth\\\\ Outer}{pics/pic2.jpg}");

        String info = underTest.getPersonalInfo();
